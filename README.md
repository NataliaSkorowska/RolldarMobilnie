...
| ------------- | ------------- |------|------|-------|
1| Widoczność strony głównej | Serwer, na którym zamieszczona jest aplikacja jest uruchomiony i poprawnie skonfigurowany. | 1. Wejdź w aplikację "RolldarMobilnie". 2. Przyjrzyj się jak wygląda widok strony głównej aplikacji. | Strona główna aplikacji Rolldar zawierająca wyśrodkowane logo firmy oraz formularz logowania zostaje wyświetlona. |
| 2 | Formularz logowania| |1. Wpisz nazwę użytkownika w pole "Nazwa" 2. Wpisz odpowiadające temu użytkownikowi hasło w pole "Hasło"  |Użytkownik może wpisać tekst w pola formularza logowania. Wpisane hasło zostaje wyświetlone w postaci kropek.|
