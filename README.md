...
| 24 |  Walidacja formularza nowego zamówienia |Użytkownik znajduje się na widoku "Dodaj zamówienie". Widok "Dodaj zamówienie" zawiera formularz nowego zamówienia.|1. Wpisz w pole "Imie i nazwisko" jeden znak. <br> 2. Naciśnij przycisk "Zapisz" znajdujący się pod formularzem.|Tekst zapisany czerwoną czcionką "Nieprawidłowy" zostaje wyświetlony bezpośrednio pod polem "Imie i nazwisko".
